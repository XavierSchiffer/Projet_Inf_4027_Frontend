...
class JWTAuthentication(authentication.BaseAuthentication):
    authentication_header_prefix = 'Bearer'  # ✅ Mettre 'Bearer' au lieu de 'Token'
    ...
    def authenticate(self, request):
        ...
        if len(auth_header) != 2:
            return None  # ✅ Mauvais format d'authentification
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            ...
            raise exceptions.AuthenticationFailed("Aucun utilisateur trouvé.")
...
#     def _authenticate_credentials(self, request, token):
#         # print("here we us", jwt.decode(token, settings.SECRET_KEY,algorithms="HS256"))
#         try:
#             # print("here we us", jwt.decode(token, settings.SECRET_KEY,algorithms="HS256"))
#             payload = jwt.decode(token, settings.SECRET_KEY,algorithms="HS256")
#         except:
#             msg = 'Invalid authentication. Could not decode token.'
#             if exceptions.AuthenticationFailed:
